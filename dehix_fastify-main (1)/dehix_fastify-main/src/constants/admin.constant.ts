...
export const ADMIN_ID_ENDPOINT = "";
...
// Endpoint for fetching all skills for admin
export const ADMIN_ALL_SKILL_ENDPOINT = "/admin";

export const UPDATE_ADMIN_BY_ID = "/:admin_id";
