...
export function ChatList({
  ...
  const handleStartNewChat = async (selectedUser: NewChatUser) => {
    ...
    if (existingConversation) {
      console.log('Setting active conversation to existing chat:', existingConversation);
    ...
    try {
      ...
      if (newDocSnap.exists()) {
        ...
        console.log('Setting active conversation to new chat:', conversationDataForState);
        setConversation(conversationDataForState);
      } else {
